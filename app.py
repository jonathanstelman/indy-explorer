...
STATE_ZOOM.update({
    "Alaska": 3.4, "Arizona": 5.7, "California": 5.2, "Colorado": 5.8,
    "Idaho": 5.9, "Maine": 6.4, "Massachusetts": 7.2, "Montana": 5.4,
    "Nevada": 5.6, "New Hampshire": 6.8, "New Mexico": 5.8, "New York": 6.2,
    "Oregon": 6.0, "Texas": 5.0, "Vermont": 6.8, "Washington": 6.0,
    "Wyoming": 5.9,
})
STATE_ZOOM.update({p: 5.2 for p in _CANADA_PROVINCES})
STATE_ZOOM.update({
    "British Columbia": 5.0, "Manitoba": 5.0, "New Brunswick": 6.0,
    "Newfoundland and Labrador": 5.6, "Northwest Territories": 4.5,
    "Nova Scotia": 6.0, "Nunavut": 4.0, "Ontario": 4.8,
    "Prince Edward Island": 6.6, "Quebec": 4.8, "Saskatchewan": 5.0,
    "Yukon": 4.5,
})
    ...
    if view_subset.empty:
        ...
        if len(view_subset) == 1:
            ...
            if state_zoom is not None:
                ...
                view_state.zoom = COUNTRY_ZOOM.get(
